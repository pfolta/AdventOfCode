...
class Day20JurassicJigsaw(
    ...
    override fun partOne(): Long {
        val tileMap =
            generateSequence(mapOf(Pair(0, 0) to tiles.first())) { previous ->
                previous +
                    previous.keys
                        .flatMap { tile ->
                            val left =
                                tiles
                                    ...
                                    .firstNotNullOfOrNull { newTile ->
                                        ...
                                        newTile.variations().firstOrNull { it.right == left }?.let {
                                            Pair(
                                                tile.first - 1,
                                                tile.second,
                                            ) to it
                            ...
                            val right =
                                tiles
                                    ...
                                    .firstNotNullOfOrNull { newTile ->
                                        ...
                                        newTile.variations().firstOrNull { it.left == right }?.let {
                                            Pair(
                                                tile.first + 1,
                                                tile.second,
                                            ) to it
                            ...
                            val bottom =
                                tiles
                                    ...
                                    .firstNotNullOfOrNull { newTile ->
                                        ...
                                        newTile.variations().firstOrNull { it.top == bottom }?.let {
                                            Pair(
                                                tile.first,
                                                tile.second - 1,
                                            ) to it
                            ...
                            val top =
                                tiles
                                    ...
                                    .firstNotNullOfOrNull { newTile ->
                                        ...
                                        newTile.variations().firstOrNull { it.bottom == top }?.let {
                                            Pair(
                                                tile.first,
                                                tile.second + 1,
                                            ) to it
